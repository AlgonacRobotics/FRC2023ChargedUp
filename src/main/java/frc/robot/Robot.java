...
public class Robot extends LoggedRobot {
  ...
  public void robotInit() {
    ...
    // Zero Encoders
    RobotContainer.m_elbowSubsystem.ElbowEncoderReset();
    RobotContainer.m_elevatorSubsystem.ElevatorEncoderReset();

    // enable camera server
    CameraServer.startAutomaticCapture();

    // Close Grabber
    RobotContainer.m_pneuSubsystem.CollectorClosed();

    // enable fan
    // RobotContainer.m_fanSubsystem.FanOn();
