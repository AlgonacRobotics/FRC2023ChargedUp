...
public class DefaultRobotConfig extends RobotConfig {
  ...
  private static final double BACK_RIGHT_MODULE_STEER_OFFSET =
      15.556641; // remember to update MODULE 3

  private static final int GYRO_ID = 23;

  private static final double TRACKWIDTH_METERS = 0.493;
  private static final double WHEELBASE_METERS = 0.609;
  private static final double ROBOT_WIDTH_WITH_BUMPERS = 0.812; // meters
  private static final double ROBOT_LENGTH_WITH_BUMPERS = 0.914; // meters
  ...
  private static final double DRIVE_KS = 0.66506;
  private static final double DRIVE_KV = 2.49290;
  ...
  private static final String CAN_BUS_NAME = "Canivore1";
  ...
  */
  ...
  private static final double AUTO_DRIVE_P_CONTROLLER = 1.5;
  private static final double AUTO_DRIVE_I_CONTROLLER = 0.0;
  private static final double AUTO_DRIVE_D_CONTROLLER = 0.0;
  private static final double AUTO_TURN_P_CONTROLLER = 1.5;
