 ...
 */
public class MK4RobotConfig extends RobotConfig {
  ...
  private static final double FRONT_LEFT_MODULE_STEER_OFFSET = 118.0371; // remember to update
  ...
  private static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 102.9968; // remember to update
  ...
  private static final double BACK_LEFT_MODULE_STEER_OFFSET = -189.7051; // remember to update
  ...
  private static final double BACK_RIGHT_MODULE_STEER_OFFSET = 40.3335; // remember to update

  private static final int GYRO_ID = 23;

  private static final double TRACKWIDTH_METERS = 0.55;
  private static final double WHEELBASE_METERS = 0.55;
  private static final double ROBOT_WIDTH_WITH_BUMPERS = 0.86; // meters
  private static final double ROBOT_LENGTH_WITH_BUMPERS = 0.86; // meters
