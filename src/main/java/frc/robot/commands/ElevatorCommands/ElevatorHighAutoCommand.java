...
public class ElevatorHighAutoCommand extends CommandBase {

  double endTime = 0;
  double duration = 0;

  /** Creates a new ElevatorUpCommand. */
  public ElevatorHighAutoCommand(double ms) {
  ...
  @Override
  public void execute() {
    RobotContainer.m_elevatorSubsystem.ElevatorHighAuto();
    RobotContainer.m_elevatorSubsystem.GetElevatorEncodervalue();
  }
