...
public class AutonMiddleBalanceCommandGroup extends SequentialCommandGroup {
  /** Creates a new ScoreHighCommandGroup. */
  public AutonMiddleBalanceCommandGroup() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new ElbowHalfLowerAutoCommand(1000),
        new ElevatorHighAutoCommand(2500),
        new ElbowHighAutoCommand(1200),
